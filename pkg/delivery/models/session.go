...
type Session struct {
	ID           int       `json:"id,omitempty"`            // ID uniquely identifies the session.
	UserID       int       `json:"user-id,omitempty"`       // UserID specifies the ID of the user this session belongs to.
