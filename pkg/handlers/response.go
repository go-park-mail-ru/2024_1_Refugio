...
func enableCors(w *http.ResponseWriter, r *http.Request) {
	(*w).Header().Set("Access-Control-Allow-Origin", "http://89.208.223.140:8081, http://127.0.0.1:8081")
	// (*w).Header().Set("Access-Control-Allow-Origin", "http://89.208.223.140:8081")
