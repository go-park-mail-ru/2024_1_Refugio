...
func TestAddUser(t *testing.T) {
	...
	t.Run("UserAddFailed", func(t *testing.T) {
		...
		mock.ExpectQuery(`INSERT INTO users`).WithArgs(user.Login, user.Password, user.FirstName, user.Surname, user.Patronymic, user.Gender, user.Birthday, sqlmock.AnyArg(), user.AvatarID, user.PhoneNumber, user.Description).WillReturnError(fmt.Errorf("failed to insert user"))
...
func TestUpdateUser(t *testing.T) {
	...
	t.Run("UserUpdatedSuccessfully", func(t *testing.T) {
		...
		mock.ExpectExec(`UPDATE users`).WithArgs(newUser.FirstName, newUser.Surname, newUser.Patronymic, newUser.Gender, newUser.Birthday, newUser.AvatarID, newUser.PhoneNumber, newUser.Description, newUser.ID).WillReturnResult(sqlmock.NewResult(0, 1))
	...
	t.Run("UserUpdateFailedNoRowsAffected", func(t *testing.T) {
		...
		mock.ExpectExec(`UPDATE users`).WithArgs(newUser.FirstName, newUser.Surname, newUser.Patronymic, newUser.Gender, newUser.Birthday, newUser.AvatarID, newUser.PhoneNumber, newUser.Description, newUser.ID).WillReturnResult(sqlmock.NewResult(0, 0))
	...
	t.Run("UserUpdateFailedDBError", func(t *testing.T) {
		...
		mock.ExpectExec(`UPDATE users`).WithArgs(newUser.FirstName, newUser.Surname, newUser.Patronymic, newUser.Gender, newUser.Birthday, newUser.AvatarID, newUser.PhoneNumber, newUser.Description, newUser.ID).WillReturnError(fmt.Errorf("database error"))
