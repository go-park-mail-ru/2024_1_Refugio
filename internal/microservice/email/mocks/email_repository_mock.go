...
func (m *MockEmailRepository) Add(email *domain_models.Email, ctx context.Context) (int64, *domain_models.Email, error) {
	m.ctrl.T.Helper()
...
// AddProfileEmail mock base method.
func (m *MockEmailRepository) AddProfileEmail(email_id int64, sender, recipient string, ctx context.Context) error {
	m.ctrl.T.Helper()
...
// GetAllIncoming mock base method.
func (m *MockEmailRepository) GetAllIncoming(login string, offset, limit int, ctx context.Context) ([]*domain_models.Email, error) {
	m.ctrl.T.Helper()
...
// GetAllSent mock base method.
func (m *MockEmailRepository) GetAllSent(login string, offset, limit int, ctx context.Context) ([]*domain_models.Email, error) {
	m.ctrl.T.Helper()
